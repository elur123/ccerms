        ...
        <div class="section text-center" id="researchlist">
            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 ml-auto mr-auto">
                    <h4><small>Search Title</small><input v-model="search" @keyup="SearchResearch(search)" type="text"
                            placeholder="Please Enter Research Title" class="form-control text-center"></h4>
                            ...
                            <tbody>
                                <tr v-for="(research, index) in files.data" :key="research.res_id">
                                    ...
                                    <td class="td-actions text-right">
                                        <a href="#viewer" @click="view(index)" type="button" rel="tooltip" class="btn btn-danger btn-link btn-sm">
