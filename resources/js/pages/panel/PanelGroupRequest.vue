<template>
    <div>
        ...
        <div class="main-panel" id="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a v-if="isManage == false" class="navbar-brand" href="#">Panel >> Group Request </a>
                        <a v-if="isManage == true" @click="Unmanage" class="navbar-brand" href="#">Back </a>
                    </div>
            ...
            <div class="panel-header panel-header-sm" style="background:#138030;">
            </div>
            <div class="content">
                <div class="row">
